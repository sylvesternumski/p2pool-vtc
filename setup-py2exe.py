    ...
    setup(name='p2pool',
        ...
        data_files=[
            ...
            ('web-static/css', [
                ...
                'web-static/css/bootstrap-darkly.min.css',
                'web-static/css/bootstrap-default.min.css',
                'web-static/css/bootstrap-flatly.min.css',
                'web-static/css/bootstrap-journal.min.css',
                'web-static/css/bootstrap-lumen.min.css',
                'web-static/css/bootstrap-readable.min.css',
                'web-static/css/bootstrap-simplex.min.css',
                'web-static/css/bootstrap-slate.min.css',
                'web-static/css/bootstrap-sortable.css',
                'web-static/css/bootstrap-spacelab.min.css',
                'web-static/css/bootstrap-superhero.min.css',
                'web-static/css/bootstrap-united.min.css',
                'web-static/css/bootstrap-yeti.min.css',
                'web-static/css/p2pool.css',
            ]),
            ('web-static/css', [
                'web-static/img/screenshot_extended_p2pool.png',
                'web-static/img/screenshot_stock_p2pool.png',
                'web-static/img/screenshot-graph.png',
            ]),
            ('web-static/js', [
                'web-static/js/bootstrap-sortable.js',
                'web-static/js/charts.js',
                'web-static/js/config.example.js',
                'web-static/js/exporting.js',
                'web-static/js/highcharts.js',
                'web-static/js/jquery-dateFormat.min.js',
                'web-static/js/p2pool.js',
        ...
        options=dict(py2exe=dict(
            ...
            includes=['twisted.web.resource', 'verthash'] + extra_includes,
        )),
        zipfile=None,
    )
finally:
